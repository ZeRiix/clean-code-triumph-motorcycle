...
declare global {
  ...
  const getLocalStorageItem: typeof import('./lib/utils')['getLocalStorageItem']
  ...
  const useLocalStorageItem: typeof import('./composables/useLocalStorage')['useLocalStorageItem']
